% Generated from ../chapters/01-the-river-the-machine-and-the-system.md
\chapter{Chapter 1 --- The River, the Machine, and the System}\label{chapter-1-the-river-the-machine-and-the-system}
...
\begin{figure}
\centering
\includegraphics[width=0.88\textwidth]{../figures/river-machine.pdf}
\caption{The machine and river are complementary views: one localizes defective components; the other asks which flows and constraints reproduce the state.}
\end{figure}

\section{Why metaphors matter}\label{why-metaphors-matter}
...
\section{From parts lists to interaction maps}\label{from-parts-lists-to-interaction-maps}
...
\section{Health as a capacity, not a snapshot}\label{health-as-a-capacity-not-a-snapshot}
