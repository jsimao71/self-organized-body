...
\chapter{Chapter 3 --- Causation Across Levels}\label{chapter-3-causation-across-levels}
...
\begin{figure}
\centering
\includesvg[width=0.82\textwidth,height=\textheight]{../figures/causal-hierarchy.svg}
