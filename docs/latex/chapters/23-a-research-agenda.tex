% Generated from ../chapters/23-a-research-agenda.md
\chapter{A Research Agenda}

The framework can be decomposed into testable propositions.

\section{Proposition 1: relaxation releases constrained motor degrees of freedom}
...
\section{Proposition 2: long practice produces durable structural change}
...
\section{Proposition 3: higher-level challenges produce multiscale adaptation}
...
\section{Proposition 4: cycles outperform continuous intervention}
...
\section{Proposition 5: health improves future adaptive capacity}
...
\section{Proposition 6: attractor transitions show early-warning signals}
...
\tightlist
\item
  detailed longitudinal N-of-1 documentation;
\item
  observational cohort of experienced practitioners;
\item
  mechanistic short-duration laboratory studies;
\item
  randomized comparison of practice components;
\item
  multi-year resilience and structural outcomes;
\item
  replication across cultures and training traditions.
\end{enumerate}
