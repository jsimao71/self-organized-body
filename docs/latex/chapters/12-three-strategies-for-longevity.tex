% Generated from ../chapters/12-three-strategies-for-longevity.md
\chapter{Chapter 12 --- Three Strategies for Longevity}\label{chapter-12-three-strategies-for-longevity}
...
\section{Strategy One: Prevent disease and optimize measurable risk}\label{strategy-one-prevent-disease-and-optimize-measurable-risk}
...
\section{Strategy Two: Measure and engineer the organism}\label{strategy-two-measure-and-engineer-the-organism}
...
\section{A fourth emphasis: restore endogenous self-organization}\label{a-fourth-emphasis-restore-endogenous-self-organization}
...
\begin{figure}
\centering
\includegraphics[width=0.88\textwidth]{../figures/longevity-strategies-v4.pdf}
\caption{The strategies overlap but begin at different intervention levels: risk prevention, measurement and engineering, direct damage repair, and restoration of adaptive self-organization.}
\end{figure}

\section{How the strategies differ in their implicit model}\label{how-the-strategies-differ-in-their-implicit-model}
