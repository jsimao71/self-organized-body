% Generated from ../chapters/10-plasticity-lineages-and-regeneration.md
\chapter{Chapter 10 --- Plasticity, Lineages, and Regeneration}\label{chapter-10-plasticity-lineages-and-regeneration}
...
Dedifferentiation moves a mature cell toward a less specialized state. Transdifferentiation changes one differentiated type into another. Experimental reprogramming can return cells toward pluripotency or partially reset aspects of cellular age \autocite{merrell2016plasticity,yucel2024reprogramming}. Injury can expose plasticity that is normally suppressed.
...
The optic nerve illustrates the distinction. In the 2020 OSK mouse experiments, targeted expression of Oct4, Sox2, and Klf4 in retinal ganglion cells promoted axon regeneration and restored some visual function \autocite{lu2020reprogramming}. The result did not require a remote progenitor population migrating into the eye. Surviving mature cells changed state and regrew processes.
...
\section{Regeneration across species}\label{regeneration-across-species}
...
\section{The lineage argument in detail}\label{the-lineage-argument-in-detail}
...
\section{Natural and engineered triggers}\label{natural-and-engineered-triggers}
