% Generated from ../chapters/08-form-as-multiscale-memory.md
\chapter{Chapter 8 --- Form as Multiscale Memory}\label{chapter-8-form-as-multiscale-memory}
...
This coordination can be described as \textbf{multiscale memory}. The genome stores molecular possibilities. Chromatin stores aspects of cell history. Tissue geometry, extracellular matrix, bioelectric patterns, neural maps, vascular topology, and mechanical loading all preserve information about organization.
