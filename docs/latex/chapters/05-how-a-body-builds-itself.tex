...
\chapter{How a Body Builds Itself}\label{chapter-5-how-a-body-builds-itself}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth,height=.68\textheight]{../figures/lineage-landscape.pdf}
