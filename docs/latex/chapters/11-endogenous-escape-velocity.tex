...
\chapter{Chapter 11 --- Endogenous Escape Velocity}\label{chapter-11-endogenous-escape-velocity}
...
\begin{figure}
\centering
\includesvg[width=0.9\textwidth,height=\textheight]{../figures/reserve-damage-model.svg}
