% Generated from ../chapters/06-form-as-a-multiscale-memory.md
\chapter{Chapter 6 --- Form as a Multiscale Memory}\label{chapter-6-form-as-a-multiscale-memory}
...
The idea of a \textbf{healthy attractor} becomes biologically meaningful here. Healthy human bodies vary, but they occupy a restricted region of possible morphologies. Development repeatedly produces bilateral organization, coordinated joints, a characteristic organ layout, and functional proportions despite genetic and environmental variation. The healthy form is not one exact geometry; it is a basin of viable configurations.
