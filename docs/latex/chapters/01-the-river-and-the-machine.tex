...
\chapter{Chapter 1 --- The River and the Machine}\label{chapter-1-the-river-and-the-machine}
...
\begin{figure}
\centering
\includesvg[width=0.92\textwidth,height=\textheight]{../figures/river-machine.svg}
