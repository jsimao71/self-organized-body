% Generated from ../chapters/08-plasticity-repair-and-regeneration.md
\chapter{Chapter 8 --- Plasticity, Repair, and Regeneration}\label{chapter-8-plasticity-repair-and-regeneration}

The word \emph{healing} hides several different biological events.
...
A 2020 mouse study expressed Oct4, Sox2, and Klf4 in retinal ganglion cells and reported axonal regeneration and partial restoration of visual function in injury and aging models \autocite{lu2020reprogramming}. The result matters because it shows that mature neuronal capacity is not absolutely fixed. It does not show that meditation, fasting, or systemic relaxation reproduces this intervention in humans.
