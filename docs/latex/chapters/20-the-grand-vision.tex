% Generated from ../chapters/20-the-grand-vision.md
\chapter{Chapter 20 --- The Grand Vision: Growing Young by Continuing to Become}\label{chapter-20-the-grand-vision-growing-young-by-continuing-to-become}
...
The phrase \textbf{grow young} should therefore be interpreted carefully. Youth is not one body shape or one biomarker. It is a high capacity to reorganize in response to the world. Growing young means preserving or recovering that capacity while retaining the judgment, commitments, and history acquired with age.
