% Generated from ../chapters/07-from-one-cell-to-a-body.md
\chapter{Chapter 7 --- From One Cell to a Body: Embryogenesis and Morphogenesis}\label{chapter-7-from-one-cell-to-a-body-embryogenesis-and-morphogenesis}
...
Cells specialize through combinations of signalling pathways, transcriptional regulation, timing, and position. Morphogens such as Wnt, BMP, Hedgehog, FGF, and TGF-β create graded signals. A cell does not simply read ``become a neuron.'' It interprets concentrations, duration, neighbours, mechanical context, and its previous state \autocite{basson2012signaling}.

Morphogenesis is the production of shape. Cells change adhesion, polarity, proliferation, and movement. Sheets fold, tubes close, branches form, and tissues push against one another. Mechanical force is not merely an outcome of gene expression; it feeds back into cell fate and tissue growth \autocite{shahbazi2020human,sutlive2021mechanical}.

Conrad Waddington represented differentiation as an epigenetic landscape: a ball rolls through branching valleys toward stable cell fates \autocite{waddington1957strategy}. The metaphor captures a loss of options as development proceeds. But modern work shows that the landscape can sometimes be reshaped. Mature cells can dedifferentiate, transdifferentiate, or be experimentally reprogrammed \autocite{merrell2016plasticity,yamanaka2010nuclear}.

Bioelectric signals add another layer. Patterns of membrane voltage across cell collectives can influence growth, polarity, gene expression, and anatomical outcomes. Michael Levin and colleagues argue that such patterns participate in storing and regulating large-scale form \autocite{levin2021bioelectric,pezzulo2016topdown}. The field remains active and interpretively contested, but it demonstrates that developmental information is not confined to DNA sequence.

\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{../figures/lineage-landscape-v4.pdf}
\caption{Development is a branching but partially revisable landscape. Cell fate depends on gene regulation, signalling, mechanics, bioelectric state, and position.}
\end{figure}
...
\section{Patterning axes and symmetry breaking}\label{patterning-axes-and-symmetry-breaking}
...
\section{Organogenesis as reciprocal construction}\label{organogenesis-as-reciprocal-construction}
...
\section{Development does not end cleanly}\label{development-does-not-end-cleanly}
