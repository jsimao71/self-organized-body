% Generated from ../chapters/12-the-healthy-attractor.md
\chapter{The Healthy Attractor}
...
This suggests a \textbf{healthy basin}: not one perfect body, but a bounded family of configurations compatible with coordinated function.

\section{Development without a stored picture}
...
\section{Displacement from the basin}
...
\section{Recovering original shape}
...
The result is more accurately called \textbf{recovery of original organization}.
...
\section{Not all barriers are attractor barriers}
...
\section{Practitioner implication}
